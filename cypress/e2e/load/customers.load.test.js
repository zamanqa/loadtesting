...
export function setup() {
  ...
  const res = k6.http.get(
    `${k6.BASE_URL}/${k6.API_VERSION}/${companyId}/circulydb/customers?page=1&per_page=1&sort=created_at&desc=true`,
...
export function handleSummary(data) {
  return {
    'cypress/e2e/load/reports/customers-load-report.html': buildHtmlReport(data, REPORT_CONFIG),
